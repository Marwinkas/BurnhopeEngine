...
namespace burnhope
{
  ...
  std::vector<char> BurnhopePipeline::readFile(const std::string &filepath)
  {
  ...
  void BurnhopePipeline::createShaderModule(const std::vector<char> &code, VkShaderModule *shaderModule)
  {
  ...
  void BurnhopePipeline::bind(VkCommandBuffer commandBuffer)
  {
  ...
  void BurnhopePipeline::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo)
  {
    ...
    configInfo.dynamicStateEnables = {VK_DYNAMIC_STATE_VIEWPORT, VK_DYNAMIC_STATE_SCISSOR, VK_DYNAMIC_STATE_FRAGMENT_SHADING_RATE_KHR};
  ...
  void BurnhopePipeline::createComputePipeline(const std::string &compFilepath, VkPipelineLayout pipelineLayout)
  {
